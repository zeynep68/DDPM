...
def get_args_parser_vit():
    ...
    parser.add_argument('--norm_last_layer', default=False,
                        type=utils.bool_flag, help="""Whether or not to 
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser('DINO', parents=[get_args_parser_vit()])
